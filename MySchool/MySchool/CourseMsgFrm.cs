...
namespace MySchool
{
    public partial class CourseMsgFrm : Form
    {
        ...
        private void btnYes_Click(object sender, EventArgs e)
        {
            ...
            string connString = @"Data Source=DESKTOP-162V1H5\ONLY;Initial Catalog=MySchool;Integrated Security=True";
            string sql = String.Format("INSERT INTO CourseMsg(CourseName, CourseClass, Required,Credit, PrelectionCredit, ExperimentCredit) VALUES('{0}','{1}','{2}','{3}','{4}','{5}')", courseName, courseClass, isRequired, credit, prelectionCredit, experimentCredit);
